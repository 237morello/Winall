...
/** SVG GitHub officiel monochrome */
function GitHubIcon() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
 ...
 * @description Bouton de connexion sociale (Google/GitHub) avec icône de marque officielle.
 * Déclenche le flux OAuth via Better Auth.
 */
